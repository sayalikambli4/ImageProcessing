...
import javax.imageio.ImageIO;
   ...
   public class Dilation {        
        ...
        public void dilated_image(){
        try{
         File originalImage = new File("C:\\FinalProject\\src\\Images\\Thresold.png");
        ...
        Color L = new Color(img.getRGB(j-1,i));  //left pixel
        ...
        int Ans=0;
        if(oriP==0)     //IF original pixel is black, keep it black
          {Ans=0;}    
       else if(topP==0 || rightP==0 || bottomP==0 || leftP==0)     //if its any neighbour has the black pixel value
          {Ans=0;}    //make that pixel as black
       else{Ans=255;} //if all neighbours are white, make it white
        
     Color gColor=new Color(Ans,Ans,Ans);
     otherImage.setRGB(j,i,gColor.getRGB());
     }
   }
 ImageIO.write(otherImage,"png",new File("C:\\FinalProject\\src\\Images\\Dilation.png"));
 System.out.println("Dilation is Done Succesfully"); 
}
catch(IOException e){
System.out.println("Error while reading - Dilation part");
        }
    }
}